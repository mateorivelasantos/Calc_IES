...
def Calc_Bach():
	...
	ventana.configure(background="white")
	ventana.wm_attributes("-alpha", 0.95)
	global menubar,Titulo1,Boton_0,Boton_1,Boton_2,Boton_3,Boton_4,Boton_5,Boton_6,Boton_7,Boton_8,Boton_9,Boton_mas,Boton_menos,Boton_por,Boton_entre,Boton_igual,Boton_borrar,Boton_punto,Boton_elevar,Boton_raiz,Boton_parA
	...
	menubar.add_cascade(label="Menu", menu=menu_bar)

	menu_bar.add_command(label="IR a menu",command=fCalc_Bach)
...
img = ImageTk.PhotoImage(Image.open("Ies.jpeg"))
panel = Label(ventana, image = img)
panel.place(x = 50, y = 70)
